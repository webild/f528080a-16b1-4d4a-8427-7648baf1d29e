...
interface TextScrollBackgroundHighlightProps {
  text?: string;
...
const TextScrollBackgroundHighlight = ({
  text = "",
  children,
  className = "",
  duration = 1,
  ...
  ariaLabel,
  gradientColors,
}: TextScrollBackgroundHighlightProps) => {
...
TextScrollBackgroundHighlight.displayName = "TextScrollBackgroundHighlight";

export default memo(TextScrollBackgroundHighlight);
