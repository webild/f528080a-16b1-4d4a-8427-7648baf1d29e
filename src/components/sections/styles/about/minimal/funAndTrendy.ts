...
export function getFunAndTrendyMinimalStyle(
  ...
  return {
    ...
    descriptions: {
      className: `${theme.text.white} ${theme.description.className} md:!text-3xl text-center`,
...
export const funAndTrendyMinimalAboutStyle = getFunAndTrendyMinimalStyle(1);
